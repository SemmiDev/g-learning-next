import { prosesPullSmartAction } from '@/actions/instansi/profil/sinkron/smart/proses-pull'
import { statusSinkronSmartAction } from '@/actions/instansi/profil/sinkron/smart/status'
