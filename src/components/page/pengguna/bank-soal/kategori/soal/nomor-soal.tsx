import { DataType as SoalType } from '@/actions/pengguna/bank-soal/soal/list'
  ...
  return (
    <div className="flex flex-col pb-2">
      ...
      <div className="max-h-96 overflow-y-auto m-auto px-2 pb-2">
        {(listSoalPilihan.length > 0 || tipeSoal === 'single-choice') && (
          <>
            <Text
              size="sm"
              weight="semibold"
        ...
        {(listSoalEsai.length > 0 || tipeSoal === 'essay') && (
          <>
            <Text
              size="sm"
              weight="semibold"
