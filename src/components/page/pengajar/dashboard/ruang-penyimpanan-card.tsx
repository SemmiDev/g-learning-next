    ...
    <>
      ...
      >
        <tspan alignmentBaseline="middle" fontSize="16px">
          {formatBytes(props.data[1] - props.data[0])}
        </tspan>
      </text>
      <text
        x={cx}
      ...
      <text
        ...
        dominantBaseline="central"
      >
        <tspan fontSize="16px">{formatBytes(props.data[1])}</tspan>
      </text>
    </>
  )
}

export default function RuangPenyimpananCard() {
  const data = [
    { name: 'Penyimpanan Tersedia', value: 716800 },
    { name: 'Total Digunakan', value: 1048576 },
  ]
