...
import { paketPenggunaSelectDataApi } from '@/services/api/admin/async-select/paket-pengguna'
import { penggunaAktifSelectDataApi } from '@/services/api/admin/async-select/pengguna-aktif'
import { lihatDetailPaketPenggunaApi } from '@/services/api/admin/paket-pengguna/lihat-detail-pengguna'
import { lihatTagihanPenggunaApi } from '@/services/api/admin/tagihan-pengguna/lihat'
import { ubahTagihanPenggunaApi } from '@/services/api/admin/tagihan-pengguna/ubah'
            ...
            <>
              <div className="flex flex-col gap-4 p-3">
                ...
                <ControlledAsyncPaginateSelect
                  ...
                  action={penggunaAktifSelectDataApi}
                  construct={(data) => ({
                    label: data.nama,
                    value: data.id,
                  })}
                ...
                <ControlledAsyncPaginateSelect
                  ...
                  action={paketPenggunaSelectDataApi}
                  construct={(data) => ({
                    label: data.nama,
                    value: data.id,
                    harga: data.harga,
