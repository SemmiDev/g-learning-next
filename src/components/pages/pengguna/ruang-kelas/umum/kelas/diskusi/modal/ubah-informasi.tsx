...
import { ubahAktifitasInformasiApi } from '@/services/api/pengguna/ruang-kelas/aktifitas/umum/ubah-informasi'
...
export default function UbahInformasiModal({
  ...
  const onSubmit: SubmitHandler<UbahInformasiFormSchema> = async (data) => {
    ...
    await handleActionWithToast(
      processApi(ubahAktifitasInformasiApi, idKelas, id, data),
      {
        loading: 'Menyimpan...',
