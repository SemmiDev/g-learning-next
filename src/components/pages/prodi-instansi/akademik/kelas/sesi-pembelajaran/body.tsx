...
import { listSesiPembelajaranApi } from '@/services/api/prodi-instansi/akademik/kelas/sesi-pembelajaran/list'
...
export default function SesiPembelajaranBody() {
  ...
  const queryKey = [
    'prodi-instansi.akademik.kelas.sesi-pembelajaran.list',
    idKelas,
  ]
