...
import { dataPersentaseKehadiranApi } from '@/services/api/prodi-instansi/akademik/kelas/presensi/persentase-kehadiran'
...
export default function ChartPersentaseKehadiranCard({
  ...
  >({
    queryKey: [
      'prodi-instansi.akademik.kelas.presensi.persentase-kehadiran',
      idKelas,
    ],
    queryFn: async () => {
