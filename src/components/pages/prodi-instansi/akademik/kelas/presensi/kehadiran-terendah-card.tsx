...
import { tableKehadiranTerendahApi } from '@/services/api/prodi-instansi/akademik/kelas/presensi/table-kehadiran-terendah'
...
export default function KehadiranTerendahCard({
  ...
  const {
    ...
    queryKey: [
      'prodi-instansi.akademik.kelas.presensi.kehadiran-terendah',
      idKelas,
    ],
