...
import { totalRuangPenyimpananApi } from '@/services/api/prodi-instansi/dashboard/total-ruang-penyimpanan'
...
export default function DashboardTotalRuangPenyimpananCard() {
  ...
  const { data } = useQuery({
    queryKey: ['prodi-instansi.dashboard.total-ruang-penyimpanan'],
