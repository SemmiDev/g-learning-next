...
import { tableKaryawanTerbaikApi } from '@/services/api/fakultas-instansi/dashboard/table-karyawan-terbaik'
import cn from '@/utils/class-names'
import { useQuery } from '@tanstack/react-query'
import { ColumnsType } from 'rc-table'
import { PiStarFill } from 'react-icons/pi'

const queryKey = ['fakultas-instansi.dashboard.karyawan-terbaik']
