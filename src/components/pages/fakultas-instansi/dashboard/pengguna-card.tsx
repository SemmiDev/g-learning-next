...
import { tablePenggunaApi } from '@/services/api/fakultas-instansi/dashboard/table-pengguna'
import { fileSizeToKB, formatBytes } from '@/utils/bytes'
import cn from '@/utils/class-names'
import { angka } from '@/utils/text'
import { ColumnsType } from 'rc-table'
import { LuEye } from 'react-icons/lu'
import LihatModal from '../profil-instansi/pengguna/modal/lihat'
...
export default function DashboardPenggunaCard({
  ...
  const {
    ...
    queryKey: ['fakultas-instansi.dashboard.table-pengguna'],
