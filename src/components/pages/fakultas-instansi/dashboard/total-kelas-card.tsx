...
import { totalKelasApi } from '@/services/api/fakultas-instansi/dashboard/total-kelas'
...
export default function DashboardTotalKelasCard() {
  ...
  const { data } = useQuery({
    queryKey: ['fakultas-instansi.dashboard.total-kelas'],
    queryFn: makeSimpleApiQueryData(totalKelasApi),
  })
