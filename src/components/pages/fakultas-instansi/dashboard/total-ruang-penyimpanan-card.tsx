...
import { totalRuangPenyimpananApi } from '@/services/api/fakultas-instansi/dashboard/total-ruang-penyimpanan'
...
export default function DashboardTotalRuangPenyimpananCard() {
  ...
  const { data } = useQuery({
    queryKey: ['fakultas-instansi.dashboard.total-ruang-penyimpanan'],
    queryFn: makeSimpleApiQueryData(totalRuangPenyimpananApi),
  })
