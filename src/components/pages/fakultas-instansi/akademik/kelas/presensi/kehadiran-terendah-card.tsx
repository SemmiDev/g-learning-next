...
import { tableKehadiranTerendahApi } from '@/services/api/fakultas-instansi/akademik/kelas/presensi/table-kehadiran-terendah'
import cn from '@/utils/class-names'
import { useParams } from 'next/navigation'
import { ColumnsType } from 'rc-table'

type KehadiranTerendahCardProps = {
  className?: string
}

export default function KehadiranTerendahCard({
  className,
}: KehadiranTerendahCardProps) {
  ...
  const {
    ...
    queryKey: [
      'fakultas-instansi.akademik.kelas.presensi.kehadiran-terendah',
      idKelas,
    ],
