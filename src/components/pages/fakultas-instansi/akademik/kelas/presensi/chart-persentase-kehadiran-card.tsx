...
import { dataPersentaseKehadiranApi } from '@/services/api/fakultas-instansi/akademik/kelas/presensi/persentase-kehadiran'
...
export default function ChartPersentaseKehadiranCard({
  ...
  >({
    queryKey: [
      'fakultas-instansi.akademik.kelas.presensi.persentase-kehadiran',
      idKelas,
    ],
    queryFn: async () => {
