...
import { tableAbsensiPesertaApi } from '@/services/api/fakultas-instansi/akademik/kelas/presensi/table-absensi-peserta'
import { lihatSesiPembelajaranApi } from '@/services/api/fakultas-instansi/akademik/kelas/sesi-pembelajaran/lihat'
...
export default function RekapPresensiDetailSesiSection({
  ...
  const { data, isLoading } = useQuery({
    queryKey: [
      'fakultas-instansi.akademik.kelas.presensi.sesi-aktif',
      idKelas,
      idSesi,
    ],
