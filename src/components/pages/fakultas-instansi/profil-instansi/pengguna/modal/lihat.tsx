...
import { lihatPenggunaApi } from '@/services/api/fakultas-instansi/profil-instansi/pengguna/lihat'
...
export default function LihatModal({ id, show, onHide }: LihatModalProps) {
  ...
  const { data, isLoading, isFetching } = useQuery({
    queryKey: ['fakultas-instansi.profil-instansi.pengguna.table.lihat', id],
