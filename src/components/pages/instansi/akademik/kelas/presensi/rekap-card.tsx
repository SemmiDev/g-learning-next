...
import { tableSesiAbsensiApi } from '@/services/api/instansi/akademik/kelas/presensi/table-sesi-absensi'
...
export default function RekapPresensiCard({
  ...
  const {
    ...
    queryKey: ['instansi.akademik.kelas.presensi.list-sesi', idKelas],
