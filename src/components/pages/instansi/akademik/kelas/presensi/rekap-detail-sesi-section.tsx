...
import { lihatKelasApi } from '@/services/api/instansi/akademik/kelas/lihat'
import { tableAbsensiPesertaApi } from '@/services/api/instansi/akademik/kelas/presensi/table-absensi-peserta'
import { lihatSesiPembelajaranApi } from '@/services/api/instansi/akademik/kelas/sesi-pembelajaran/lihat'
...
export default function RekapPresensiDetailSesiSection({
  ...
  const { data: dataKelas } = useQuery({
    queryKey: ['instansi.akademik.kelas.lihat', idKelas],
    queryFn: makeSimpleApiQueryData(lihatKelasApi, idKelas),
  })

  const { data, isLoading } = useQuery({
    queryKey: ['instansi.akademik.kelas.presensi.sesi-aktif', idKelas, idSesi],
