...
import { tableKehadiranTerendahApi } from '@/services/api/instansi/akademik/kelas/presensi/table-kehadiran-terendah'
...
export default function KehadiranTerendahCard({
  ...
  const {
    ...
    queryKey: ['instansi.akademik.kelas.presensi.kehadiran-terendah', idKelas],
