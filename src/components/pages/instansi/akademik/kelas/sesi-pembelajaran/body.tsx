...
import { listSesiPembelajaranApi } from '@/services/api/instansi/akademik/kelas/sesi-pembelajaran/list'
...
export default function SesiPembelajaranBody() {
  ...
  const queryKey = ['instansi.akademik.kelas.sesi-pembelajaran.list', idKelas]
