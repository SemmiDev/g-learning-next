import LinimasaBody from '@/components/pages/pengguna/ruang-kelas/akademik/kelas/linimasa/body'
import DiskusiBody from '@/components/pages/pengguna/ruang-kelas/umum/kelas/diskusi/body'
