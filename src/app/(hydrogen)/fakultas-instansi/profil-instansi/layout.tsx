import HeaderCard from '@/components/pages/fakultas-instansi/profil-instansi/header-card'
import PageHeader from '@/components/shared/page-header'
import { routes } from '@/config/routes'
import { metaObject } from '@/config/site.config'
import { dataProfilAction } from '@/services/actions/fakultas-instansi/profil-instansi/detail/data'
